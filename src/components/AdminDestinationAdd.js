...
const Dashboard = () => {
  ...
  const handleImageChange = (e) => {
    ...
    for (let i = 0; i < files.length; i++) {
      if (files[i].size <= maxSize) {
        ...
        alert(`${files[i].name} is too large. Maximum size is 5MB.`);
      }
    }

    setpreviewUrl(previewUrl);
    setGambar(validFiles); // Set hanya file yang valid
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("http://localhost:5000/destinasi", formData, {
        withCredentials: true,
      });
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          name="location"
                          className="form-control"
                          placeholder="Kabupaten Mentawai"
                          value={location}
                          onChange={handleChange}
                        />
                      </div>
